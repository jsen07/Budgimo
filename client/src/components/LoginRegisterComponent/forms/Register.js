...
const RegisterForm = ({ handleToggle }) => {
  ...
  return (
<div className='w-full h-screen flex justify-start items-center flex-col sm:pr-4 md:h-3/4 md:items-start md:pl-4 md:py-10 lg:pl-10 lg:pr-5'>
  ...
  <h1 className='font-figtreen font-semibold text-[34px] tracking-wide my-5 sm:pl-4'> Register </h1>
  <h2 className='font-figtreen text-sm tracking-wide mb-10 sm:pl-4'> Create your account. It's free and only takes a minute. </h2>

    <form onSubmit={handleSubmit} className='border-box flex flex-col h-auto sm:w-3/4 md:w-full md:items-end xl:w-full 2xl:w-2/3'>

      <div id='row-1'className='flex flex-row w-full p-2 mb-2'>
        <div className='w-1/2 p-1 relative'>
          {/* <h2 className='p-1'> First Name</h2> */}
          <label for="first_name" className='absolute top-[0px] left-[10px] bg-white px-2 text-xs'> First name</label>
        <input
        ...
        <div className='w-1/2 p-1 relative'>
        {/* <h2> Last Name</h2> */}
        <label for="last_name" className='absolute top-[0px] left-[10px] bg-white px-2 text-xs'> Last name </label>
      <input
      ...
      <div className='w-full p-1 mb-1 relative'>
      <label for="Repeat-password" className='absolute top-[0px] left-[10px] bg-white px-2 text-xs'>Repeat password </label>
      <input
        className='w-full mt-1 p-2 text-sm border-2 border-black placeholder-gray-500 placeholder-opacity-50 focus:outline-none focus:border-b-4 focus:border-teal-500 transition'
        type="password"
    ...
    <div className='flex flex-row w-2/3 items-center justify-center h-full md:w-full md:mt-10 md:mt-0 md:h-auto 2xl:w-2/3'>
      ...
      <p onClick={()=> handleToggle()} className='underline cursor-pointer text-sm hover:scale-95 transition hover:no-underline'> Login</p>
    </div>
