  ...
  return (
    <div className="w-full h-screen text-white">
      <nav className="w-full h-16 top-0 fixed z-10 flex justify-between items-center px-4 bg-amber-500 text-black">
        ...
        <h1 className="text-xl ml-4 text-teal-600 font-hero sm:text-2xl">
          {" "}
          Budgimo{" "}
        </h1>
        <button
        ...
        >
          <svg
            className="text-teal-600 block h-8 w-8 fill-current"
            viewBox="0 0 20 20"
        ...
        <div className="hidden sm:flex flex-row space-x-6 mr-6 w-full justify-end text-md text-white">
          <a
            className="scroll-smooth cursor-pointer font-medium hover:text-teal-600 transition"
            href="#about"
          >
            About
          </a>
      ...
      <section
        id="#"
        className="relative w-full h-screen bg-cover bg-[right_15%_top] bg-no-repeat flex flex-col items-center justify-center sm:bg-[right_10%_top] lg:bg-center lg:pl-20"
      ...
      >
        ...
        <div className="w-full h-[35%] flex flex-col items-center justify-between animate-fade1 lg:flex-row lg:items-start lg:justify-between lg:m-0 lg:h-[350px]">
          <div className="w-full flex flex-col items-center justify-center lg:justify-start lg:flex-col lg:items-start">
            ...
            <h1
              className="text-7xl sm:text-8xl text-teal-600 font-hero underline underline-offset-[20%]"
            ...
            <div className="animate-fade2 lg:mt-10 lg:my-4 lg:w-full lg:w-[700px]">
              ...
              <h1 className="hidden text-medium font-sans font-thin md:flex text-black mx-4 lg:m-0">
                {" "}
                With intuitive budgeting tools, real-time expense tracking, and
                insightful analytics, you can make smarter financial decisions
                effortlessly. Stay on top of your spending, set achievable
                savings goals, and gain the confidence to manage your money like
                a pro—all in one easy-to-use platform.
              </h1>
            </div>
          </div>
        ...
        <div
          id="hero"
          className="w-full flex flex-row items-center justify-center lg:items-start lg:justify-start"
        >
          ...
          <div className="relative px-6 py-3 font-bold text-white group mt-10 cursor-pointer">
            ...
            <button onClick={() => navigate("/login")} className="relative">
              Get started
            </button>
          </div>
          {/* 
<div className='w-[450px] h-[100px] border-2 border-black'></div> */}
      ...
      <section
        id="about"
        className="h-auto bg-indigo-50 p-6 flex flex-col items-center"
      >
        <h1 className="text-2xl text-center pt-6 text-teal-600 font-hero mb-8">
          {" "}
      ...
      <section
        id="services"
        className="bg-indigo-300 text-black py-10 px-4 min-h-screen"
      >
      ...
      <section id="faq" className="text-black h-auto bg-indigo-400 p-6">
        <h1 className="text-3xl font-hero text-teal-100 text-center mb-6">
          FAQ
        </h1>
        ...
        {FAQ_section.map((faq, index) => (
          <details
            key={index}
            className="bg-white rounded-lg p-4 shadow-md my-3"
          >
